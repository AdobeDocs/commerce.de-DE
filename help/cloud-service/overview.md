...
![Datenflussdiagramm, das [!DNL Adobe Commerce as a Cloud Service] Integration mit [!DNL Adobe Experience Cloud] Lösungen zeigt](./assets/data-flow.svg){zoomable="yes"}
