...
[!DNL Adobe Commerce as a Cloud Service] bietet Flexibilität, Skalierbarkeit und Effizienz, da Unternehmen digitale Abläufe schnell bereitstellen und skalieren und gleichzeitig Innovationen beschleunigen können. Die Cloud-native Infrastruktur von Adobe passt Ressourcen automatisch an Spitzenanforderungen an Traffic, Bestellungen und Katalogmanagement an.
...
![Datenflussdiagramm, das [!DNL Adobe Commerce as a Cloud Service] Integration mit [!DNL Adobe Experience Cloud] Lösungen zeigt](./assets/data-flow.png){zoomable="yes"}

## Commerce-Storefront

Um in Minutenschnelle umfassende Erlebnisse mit einfacher dokumentbasierter Bearbeitung oder visueller Bearbeitung mit [!DNL Storefront Builder] zu erstellen, verwenden Sie die [[!DNL Commerce Storefront]](https://experienceleague.adobe.com/developer/commerce/storefront/) von Adobe, die von [!DNL Edge Delivery Services] unterstützt wird.
...
>[!NOTE]
>
>[!DNL Adobe Commerce as a Cloud Service] unterstützt keine Luma-Storefronts. Wenn Sie von Adobe Commerce in der Cloud oder lokal migrieren, finden Sie unter [Vorhandene Storefronts](https://experienceleague.adobe.com/developer/commerce/storefront/discovery/#existing-storefronts) Anleitungen für den Übergang.
...
- **Isolierung** - Eine isolierte Umgebung bedeutet, dass Entwickler ihre Erweiterungen nach eigenem Ermessen aktualisieren oder ändern können, ohne sich auf eine Hauptversion zu verlassen.
...
[!DNL Commerce Foundation] bietet eine sichere automatisierte Hosting-Plattform und Self-Service-Funktionen für die Verwaltung Ihres Commerce-Programms in einer Cloud-nativen Umgebung.
