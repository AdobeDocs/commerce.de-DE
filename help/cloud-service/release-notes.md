...
Der `observer.sales_quote_item_save_before` Webhook ist jetzt in [!DNL Adobe Commerce as a Cloud Service] verfügbar. Use it to run logic before a quote item is saved. <!-- ACCS-346 -->
...
The Invoice API now supports [custom capture amounts](https://experienceleague.adobe.com/de/docs/commerce-admin/stores-sales/order-management/invoices#custom-capture-amounts) using extension attributes. <!-- ACCS-186, ACCS-197, ACCS-143 -->
