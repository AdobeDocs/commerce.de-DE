...
Um Produktdaten von einer Commerce-Instanz mithilfe der [Catalog Service GraphQL-API](https://developer.adobe.com/commerce/webapi/graphql/schema/catalog-service/) anzufordern und zu empfangen, installieren Sie den Katalog-Service. Der Katalog-Service wird als PHP-Composer-Metapaket aus dem Repository repo.magento.com bereitgestellt.
...
1. Fügen Sie das Modul `magento/catalog-service` mit dem Composer hinzu:
...
1. Fügen Sie das `magento/catalog-service` Paket mithilfe von Composer hinzu:
...
Führen Sie die folgenden Schritte aus, um den Katalog-Service nach der Installation des [!DNL Catalog Service] in Ihre Adobe Commerce-Instanz zu integrieren. Diese Integration ermöglicht die Datensynchronisation und Kommunikation zwischen der Commerce-Instanz, dem Katalog-Service und anderen unterstützenden Services. Die [SaaS-Datenexporterweiterung](../data-export/overview.md) übernimmt die Datensynchronisierung.
...
1. Führen Sie eine erste Datensynchronisation über das [Data Management Dashboard](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/data-transfer/data-sync/data-dashboard) durch.
...
- [Bestätigen Sie, dass Cron-Aufträge ausgeführt werden](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-39832).
