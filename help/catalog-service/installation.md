...
Installieren Sie den Katalog-Service, um Produktdaten von einer Commerce-Instanz mithilfe der [Catalog Service GraphQL-API](https://developer.adobe.com/commerce/services/graphql/catalog-service/) anzufordern und zu empfangen. Der Katalog-Service wird als Composer-Metapaket aus dem Repository repo.magento.com bereitgestellt.
