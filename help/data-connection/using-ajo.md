...
Mit [Adobe Journey Optimizer](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/essentials/get-started) können Sie das Commerce-Erlebnis für Ihre Kunden personalisieren. Sie können Journey Optimizer beispielsweise verwenden, um geplante Marketing-Kampagnen zu erstellen und bereitzustellen, z. B. wöchentliche Werbeaktionen für ein Einzelhandelsgeschäft, oder um eine E-Mail zu generieren, wenn ein Kunde ein Produkt zum Warenkorb hinzugefügt, aber dann den Checkout-Prozess nicht abgeschlossen hat.
...
1. [Adobe Journey Optimizer starten](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/work-efficiently/user-interface).
...
1. Befolgen Sie die [Schritte](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/personalization/personalization-use-cases/personalization-use-case-helper-functions#configure-email) im Journey Optimizer-Handbuch, um die E-Mail mit dem Transaktionsabbruch zu erstellen.
