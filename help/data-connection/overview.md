...
- [AEM](https://experienceleague.adobe.com/de/docs/experience-manager-cloud-service/content/content-and-commerce/cif-storefront/integrations/aep)
...
- [Adobe Client Data Layer (ACDL)](https://experienceleague.adobe.com/de/docs/experience-platform/tags/extensions/client/client-data-layer/overview) der zum Erfassen von Storefront-Ereignisdaten erforderlich ist
...
1. [Erstellen eines Datensatzes](https://experienceleague.adobe.com/de/docs/platform-learn/implement-mobile-sdk/experience-cloud/platform#create-a-dataset) basierend auf dem von Ihnen erstellten oder aktualisierten Schema. Dieser Datensatz enthält die Commerce-Daten, die an Experience Platform Edge gesendet werden.
1. [Erstellen Sie einen Datenstrom](https://experienceleague.adobe.com/de/docs/experience-platform/datastreams/overview) und wählen Sie das XDM-Schema aus, das die Commerce-spezifischen Feldergruppen enthält.
...
- [Hilfezentrum](https://experienceleague.adobe.com/de/docs/commerce-knowledge-base/kb/overview){target="_blank"}
- [Support-Tickets](https://experienceleague.adobe.com/de/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide#support-case){target="_blank"} — Senden Sie ein Ticket, um zusätzliche Hilfe zu erhalten.
