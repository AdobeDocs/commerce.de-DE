...
Erzwingt die Neusynchronisierung von Feed-Elementen unabhängig davon, ob sich ihre Daten geändert haben, ohne dass der Feed-Exportstatus gelöscht wird.

>[!NOTE]
>
>Erfordert Version 103.4.30 oder höher der [Datenexporterweiterung](manage-extension.md#update-a-module-to-a-specific-version).
