...
Sie müssen zuerst die Erweiterung von [Commerce Marketplace herunterladen](https://experienceleague.adobe.com/de/docs/commerce-admin/start/resources/commerce-marketplace) bevor Sie sie installieren können.
...
[Erhöhen Sie die Speicherbegrenzung](https://experienceleague.adobe.com/de/docs/commerce-on-cloud/user-guide/configure/app/php-settings#increase-php-memory-limit) für PHP in Ihrer Umgebung in `php.ini`.
