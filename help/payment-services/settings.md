...
Sie können Apple Pay nur verwenden, wenn Sie die [Apple Pay-Selbstregistrierung über PayPal](https://developer.paypal.com/docs/checkout/apm/apple-pay/#register-your-live-domain) abschließen und dann [Apple Pay konfigurieren](settings.md/#payment-buttons) für Ihre Stores durchführen. Weitere Informationen finden [ unter ](payments-options.md#apple-pay-button).
