...
1. [Bestellung erstellen und Produkte hinzufügen](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/point-of-purchase/assist/customer-account-create-order).
...
1. Nachdem Sie alle anderen erforderlichen Schritte für die Bestellung ausgeführt haben, [&#x200B; Sie sie &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/point-of-purchase/assist/customer-account-create-order?lang=en#step-3%3A-submit-the-order).
