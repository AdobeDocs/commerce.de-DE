...
- In der [ „Auftragsdetails“ ](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/order-management/orders/order-processing#view-an-order) Commerce Admin.
...
![Bekanntes Problem](../assets/bug.svg)<!-- Issue PAY-2842 --> Testen von Kreditkartentransaktionen [kann mit PayPal fehlschlagen](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26825) wenn Zahlungen in einer Sandbox-Umgebung verarbeitet werden.
...
![Bekanntes Problem](../assets/bug.svg)<!-- Issue PAY-2473 --> Die Verwendung [falschen Composer-Schlüsseln](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26826) während der Installation der Erweiterung verhindert, dass der Benutzer sich [ mit ](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/prerequisites/authentication-keys) richtigen `MAGEID` authentifiziert.

![Bekanntes Problem](../assets/bug.svg)<!-- Issue PAY-2474 --> [!DNL Payment Services] Berichte [werden möglicherweise nicht sofort synchronisiert](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26837).

![Bekanntes Problem](../assets/bug.svg)<!-- Issue PAY-2475 --> Ihr [PayPal-Sandbox-](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26836) für [!DNL Payment Services] kann nicht überprüft werden, wenn Sie dieses Konto beim Onboarding erstellen.
