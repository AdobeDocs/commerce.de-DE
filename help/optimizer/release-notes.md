...
![Korrigieren](../assets/fix.svg) **Kategoriennavigationsleistung** - Leistungsoptimierungen wurden auf den Kategoriendienst angewendet, was zu einem höheren Durchsatz und einer niedrigeren P99-Latenz für die `CategoryNavigation` Abfrage führt, was die Reaktionsfähigkeit des Dienstes verbessert und das Gesamterlebnis des Benutzers unter hoher Last verbessert.
<!--DATA-7131 DATA-7250-->
