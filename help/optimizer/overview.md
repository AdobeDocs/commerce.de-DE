...
- Die Relevanz der Produkterkennung mit einer Rangfolge verbessern, bei der **(exakte und** Übereinstimmungen) und Übereinstimmungen mit gleichen Feldern priorisiert werden. Siehe [Suchen nach Übereinstimmungen und Rangfolgen](./manage-results/search-relevance-matching.md).
...
- [AEM-Kunden](setup/product-visuals.md) die eine einfache Möglichkeit suchen, ihren Produktkatalog über eine Commerce-Engine eines Drittanbieters zu verwalten.
...
- **Private Katalogansichten** - Schränken Sie eine Katalogansicht ein, sodass nur Anfragen mit einem gültigen signierten Token ihre Daten abrufen können. Siehe [Private Katalogansichten](setup/private-catalog-view.md) für die Einrichtung.
...
>[!NOTE]
>
>Informationen zu Systemgrenzen und Lizenzierung für [!DNL Adobe Commerce Optimizer] finden Sie unter [Beschränkungen und Grenzen](boundaries-limits.md).
